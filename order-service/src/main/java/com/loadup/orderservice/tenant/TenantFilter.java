package com.loadup.orderservice.tenant;
...
public class TenantFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (tenantId == null || tenantId.isBlank()) {
            ...
            return;
            // This error is written manually here rather than through GlobalExceptionHandler, since the filter runs before Spring's
            // exception-handling machinery is even in play. Known inconsistency, documented in the README rather than silently left unexplained.
        }
            ...
            ScopedValue.where(TenantContext.TENANT_ID, tenantId)
                    .run(() -> {
                        try {
                            ...
                            // ScopedValue.run() only accepts a Runnable, which can't declare checked exceptions, so they're wrapped here and unwrapped just below.
                        }
                    });
